...
spagoUpdatePurescriptVersion token (NewRepoRelease address newTag) | address == purescriptRepo = do
  ...
  runAndOpenPR token PullRequest{ prBody = "", prAddress = spagoRepo, ..} (const $ pure ())
    ...
    , "sed -e 's/Generated by purs bundle.*/Generated by purs bundle " <> newTag <> "/g' -i test/fixtures/bundle-app.js"
    , "sed -e 's/Generated by purs bundle.*/Generated by purs bundle " <> newTag <> "/g' -i test/fixtures/bundle-module.js"
    , "sed -e 's/Generated by purs version.*/Generated by purs version " <> newTag <> "/g' -i test/fixtures/bundle-app.js"
    , "sed -e 's/Generated by purs version.*/Generated by purs version " <> newTag <> "/g' -i test/fixtures/bundle-module.js"
