...
- [spago](#spago)
  ...
  - [How do I...](#how-do-i)
    ...
    - [Bundle a project into a single JS file](#bundle-a-project-into-a-single-js-file)
      ...
      - [Exclude external modules](#exclude-external-modules)
...
When bundling apps, you may need to exclude certain external modules.  For example, javascript
may reference the `electron` module when you are compiling for `node`.
You can exclude modules using the `--external module1,module2` flag, which will be passed to `esbuild`.
