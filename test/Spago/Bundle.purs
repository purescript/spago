...
import Data.String.Utils (startsWith) as Str
...
spec = Spec.around withTempDir do
  Spec.focus $ Spec.describe "bundle" do
    ...
    Spec.it "refuses to overwrite existing file that is not Spago-generated" \{ spago, fixture } -> do
      ...
      spago [ "bundle", "--force-overwrite" ] >>= shouldBeSuccess
  ...
  checkBundle file fixture =
    checkFixture' file fixture \actual expected ->
      Str.trim actual `shouldEqualStr`
        Str.replace (Str.Pattern "// Generated by Spago v0") (Str.Replacement magicMarker) (Str.trim expected)
    where
    magicMarker = "// Generated by Spago v" <> BuildInfo.packages."spago-bin"

      -- let
      --
      --     shebang = "#!/usr/bin/env node\n"
      --     hasShebang = expected # Str.startsWith shebang
      --     expected' = fold
      --       [ if hasShebang then shebang else ""
      --       , magicMarker
      --       , expected # Str.replace (Str.Pattern shebang) (Str.Replacement "")
      --       ]
      -- in
