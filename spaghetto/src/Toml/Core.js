...
export const tomlNull = null;

import * as TOML from '@iarna/toml';

export function _tomlParser(fail, succ, s) {
  try {
    return succ(TOML.parse(s));
  }
  catch (e) {
...
export function _caseToml(isNull, isBool, isNum, isStr, isArr, isObj, j) {
